...
// const WECHAT_AUTH_BASE = 'Y29tLm1ldW0ubWluaS5zdWdhcjowN2ZlMzBiOWI0YjlmZmY1'; //先不用 后台给出登录使用的验证字符串 Y29tLm1ldW0ubWluaS5tYWxsOjQwMmZiZDZkNGM2NkNjY2M=
...
// const MAIN_DOMAIN = 'https://testzcm.chengmall.cn' //真成优选测试域名192.168.1111
const MAIN_DOMAIN = 'https://zcm.chengmall.cn' // 正式域名
const Version = '1.0'
